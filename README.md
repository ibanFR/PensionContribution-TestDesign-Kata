...
There are some bugs in the code (marked with comments). For each bug, write a unit test that fails with a good error
message. Then fix the bug and make sure the test now passes. Repeat for other bugs.
